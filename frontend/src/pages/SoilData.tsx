      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-container border border-outline-variant/50 w-fit mb-4">
            <Layers size={13} className="text-tertiary" />
            <span className="text-[11px] font-semibold tracking-wider uppercase text-on-surface-variant">Soil Nutrient Profile</span>
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-container-low border border-outline-variant/30 text-sm text-outline font-medium">
            ...
            Displaying submitted field input values — not live physical sensor telemetry.
          </div>
        </div>
            ...
            return (
              <div className="bg-surface-container rounded-xl border border-outline-variant/30 p-6 flex flex-col hover:border-outline-variant transition-colors" key={field.key}>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-lg bg-surface-container-highest flex items-center justify-center font-mono font-bold text-primary border border-outline-variant/50" title={field.label}>
                    {field.icon}
                  </div>
                  <span className="text-[10px] font-bold uppercase tracking-widest text-outline bg-surface-container-low px-2 py-1 rounded">Macronutrient</span>
                </div>
